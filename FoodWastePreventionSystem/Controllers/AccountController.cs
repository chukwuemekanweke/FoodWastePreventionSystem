...
namespace FoodWastePreventionSystem.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public AccountController(IRepository<Store> storeRepo)
        {
            StoreRepo = storeRepo;
        }
        ...
        public FileContentResult GetUserImage(string id)
        {
            ...
            if (User != null)
            {
                if (User.Image != null)
                {
                    return File(User.Image, User.Extension);
                }
                else
                {
                    return null;
        ...
        public ActionResult SignUp(AccountDetailsViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AccountDetailsViewModel AccDetVm = Session[$"AccountDetailsInfo{Request.UserHostAddress}"] as AccountDetailsViewModel;
                Debug.WriteLine("Session Info: " + AccDetVm.FirstName);
                TempData["IsRetailer"] = model.IsRetailer;
        ...
        [AllowAnonymous]
        public ActionResult LocationDetails() => View();
